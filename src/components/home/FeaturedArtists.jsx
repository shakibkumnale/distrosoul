      ...
      >
        ...
        <div className="flex space-x-4 sm:space-x-6 pb-4 sm:pb-6 min-w-max">
          {artists.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center w-full min-h-[240px] sm:min-h-[320px] bg-gradient-to-b from-gray-900/80 to-black/40 rounded-xl border border-gray-800/30">
              <Users className="h-8 w-8 sm:h-12 sm:w-12 text-purple-600/40 mb-3 sm:mb-4" />
              <p className="text-sm sm:text-base text-gray-400">No featured artists yet</p>
            </div>
          )}
        </div>
      </div>
