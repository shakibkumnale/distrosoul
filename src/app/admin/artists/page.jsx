...
export default function AdminArtists() {
  ...
  const fetchArtists = async () => {
    ...
    try {
      ...
      console.log('Artists loaded:', data.artists.length);
  ...
  const handleEdit = async (artist) => {
    try {
      ...
      console.log('Loaded artist for editing:', fullArtistData);
                  ...
                  <div key={artist._id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <Link href={`/admin/artists/${artist.slug}`} className="font-medium hover:text-purple-600">
                            {artist.name}
                          </Link>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                >
                  ...
                  <option value="premium">Premium Plan ($29.99)</option>
                  <option value="aoc">AOC Plan ($39.99)</option>
                </select>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">
