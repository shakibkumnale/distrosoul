    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        <Card>
          ...
          <CardContent>
            <p>+91 9876543210</p>
            <p className="text-sm text-gray-500 mt-1">Available Mon-Fri, 10am-6pm IST</p>
          </CardContent>
        </Card>
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Purchase our YouTube OAC plan, and we'll handle the verification process for you. You'll need to have at least 3 releases on platforms.
              </p>
            </div>
